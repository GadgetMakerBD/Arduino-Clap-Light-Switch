// Clap Light Switch
// YouTube: http://www.youtube.com/@GadgetMakerBD5
...
void loop() {
  ...
  if (millis() - ClapDetetedTime[2] < 800 && millis() - ClapDetetedTime[1] < 800 &&
      ClapDetected && ClapDetetedTime[1] - ClapDetetedTime[0] >= 800) {
